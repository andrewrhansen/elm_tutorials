--Refactored to add age field, check whether age is a number,
--password length check, and whether password contains numbers and both lower and upper case letters
